...
<svg viewBox="0 0 160 160" width="160" height="160">
  ...
  <animateTransform attributeName="transform" type="rotate" from="180 0 0" to="0 0 0" dur="6s"
  repeatCount="indefinite" />
    </path>
     <path d="M 0,70 A 65,70 0 0,0 65,0 5,5 0 0,1 75,0 75,70 0 0,1 0,70Z" fill="#756168">
  <animateTransform attributeName="transform" type="rotate" from="180 0 0" to="0 0 0" dur="3s"
  repeatCount="indefinite" />
    </path>
  </g>
