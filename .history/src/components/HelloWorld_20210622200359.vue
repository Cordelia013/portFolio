...
<svg viewBox="0 0 160 160" width="160" height="160">
  ...
  <g transform=" matrix(0.866, -0.5, 0.25, 0.433, 80, 80)">
    <path d="M 0,70 A 65,70 0 0,0 65,0 5,5 0 0,1 75,0 75,70 0 0,1 0,70Z" fill="#756168">
  <animateTransform attributeName="transform" type="rotate" from="360 0 0" to="0 0 0" dur="4s"
  repeatCount="indefinite" />
    </path>
     <path d="M 0,70 A 65,70 0 0,0 65,0 5,5 0 0,1 75,0 75,70 0 0,1 0,70Z" fill="#756168">
  <animateTransform attributeName="transform" type="rotate" from="360 0 0" to="56 0 0" dur="3s"
  repeatCount="indefinite" />
    </path>
  </g>
...
#header .nav_middle a::after,
#header .nav_middle a::before {
  content: " ";
  display: block;
  height: 0;
  position: absolute;
...
#header .nav_middle a:hover {
  border-radius: 12px;
  background: #4f4848;
  box-shadow: inset 6px 6px 7px #443e3e, inset -6px -6px 7px #5a5252;
}
#header .nav_middle a:hover::after {
  background: rgba(104, 101, 101, 0.1);
  bottom: -10%;
  height: 120%;
  position: relative;
  right: -10%;
