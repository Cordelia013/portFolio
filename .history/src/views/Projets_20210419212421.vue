...
<!-- Boutton de controle filtrage -->
        ...
        <button class="btn" onclick="filterSelection('front')"> Front</button>
        <button class="btn" onclick="filterSelection('fullStack')"> full stack</button>
...
<div class="container">
  <div class="filterDiv cars">   <h4>calendrier html/css</h4>
