  ...
  <div class="body">
    <article id="projets" style="" class="active">
      ...
      <div class="grid-container">
        <!-- Boutton de controle filtrage -->
        <div id="myBtnContainer">

          <button @click="switchBtn1" class="btn active" onclick="filterSelection('all')">
            Show all
          </button>
          
          <button @click="switchBtn2" class="btn" onclick="filterSelection('front')">Front</button>
          <button @click="switchBtn5" class="btn" onclick="filterSelection('fullStack')">
            full stack
          </button>
          <button @click="switchBtn4" class="btn" onclick="filterSelection('cms')">Cms</button>
        </div>



        <!-- projet filtrer, par cathégorie -->
        ...
        <!-- <section class="card card3">
          <h4>Projets Nucleotics</h4>
          <a href="https://gallant-bartik-bf5396.netlify.app">
            <img src="/img/nucleotic.png " alt="Projets Nucleotics" />
          </a>
          <p>
